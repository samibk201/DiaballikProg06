...
public class InterfaceTuto2 extends JPanel{
    ...
    public void init(){
        ...
        text = new JTextArea(" 1. Il y a deux joueurs, on commence la partie avec les "+
                                "pions de chaque joueur en ligne devant lui \n et la balle "+
                                "sur le pion centrale de chacun. ");
