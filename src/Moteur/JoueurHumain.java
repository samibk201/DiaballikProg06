...
class JoueurHumain extends Joueur {
	...
	/**
	 * TODO -Il faudra faire des modifs pour gérer le fait qu'il veuille faire 3
	 * actions -La gestion des coups invalides pour redonner la commande au joueur
	 * et Pour cela il faut changer le type de la fonction joueCoup dans JeuPlateau
	 **/
	@Override
